/**
 * A copy of zod helper util file
 * https://github.com/colinhacks/zod/blob/master/src/helpers/util.ts
 */
export namespace util {
  ...
  export const isInteger: NumberConstructor['isInteger'] =
      typeof Number.isInteger === 'function'
          ? (val) => Number.isInteger(val) // eslint-disable-
          : (val) =>
                typeof val === 'number' &&
                isFinite(val) &&
                Math.floor(val) === val;
...
export const getParsedType = (data: any): keyof typeof ZodParsedType => {
  const t = typeof data;
